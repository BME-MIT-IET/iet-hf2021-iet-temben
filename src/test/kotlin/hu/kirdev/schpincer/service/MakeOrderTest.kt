...
class MakeOrderTest {
    ...
    fun `check category limitations`(categoryId: Int) {
        ...
        assertDoesNotThrow { procedure.updateCategoryLimitations() }
    ...
    fun `check category limitations with too many orders`(categoryId: Int) {
        ...
        assertEquals(RESPONSE_CATEGORY_FULL, getException<FailedOrderException> { procedure.updateCategoryLimitations() }.response)
